...
OUTPUT_DIR			= $(MATTER_MAKEDIR)/my_dimmable_light/build/chip
...
INCLUDES += -I$(SDKROOTDIR)/component/common/application/matter/example/my_dimmable_light
...
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/example/my_dimmable_light/example_matter_my_dimmable_light.cpp
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/example/my_dimmable_light/matter_drivers.cpp
